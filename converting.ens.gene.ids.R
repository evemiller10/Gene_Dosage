#Function for adding a column with gene names to datafram
#Not necessarily needed now as when adding GRange object to regression model data
#get the gene names added through this
